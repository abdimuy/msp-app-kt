...
interface ReencolarSubidaPort {
    ...
    /**
     * Cortesía al GUARDAR o CANCELAR: reencola la subida con reemplazo para no esperar a la
     * siguiente apertura de sesión. Nunca se necesita para que la corrección llegue al
     * servidor.
     */
