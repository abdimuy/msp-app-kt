...
interface ComprobantesPort {
     ...
     */
    suspend fun importar(uri: String): ComprobanteDelAbono
     ...
     * llama en su dispatcher de IO y publica el resultado ya listo, con lo que la
     * rejilla queda como un composable puro sobre datos —que es, de paso, lo que
     * deja el golden determinista.
     */
